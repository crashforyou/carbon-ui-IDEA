      ...
      <a-layout-content>
        ...
        <a-form @submit="handleSubmit">
          <a-row gutter="16">
            ...
            <a-col :span="4">
              <a-form-item label="本轮询价可用资金">
                <a-input v-model="availableFunds" disabled></a-input>
              </a-form-item>
            </a-col>
            <a-col :span="4">
              <a-form-item label="可用配额">
                <a-input v-model="availableQuota" disabled></a-input>
              </a-form-item>
            </a-col>
          </a-row>
        </a-form>
...
onMounted(() => {
  axios
      .get(`http://localhost:8080/bulkAgreement/selectNegotiation/${record}`)
      .then((res) => {
        console.log(res);
        // 在这里添加交易数据
        // 在这里添加报价记录数据
